...
**
** Created: Tue Feb 1 00:14:34 2011
...
static const char qt_meta_stringdata_Arrow[] = {
    "Arrow\0\0go()\0"
};

const QMetaObject Arrow::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Arrow,
      qt_meta_data_Arrow, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Arrow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Arrow))
        return static_cast<void*>(const_cast< Arrow*>(this));
    if (!strcmp(_clname, "QGraphicsPathItem"))
        return static_cast< QGraphicsPathItem*>(const_cast< Arrow*>(this));
